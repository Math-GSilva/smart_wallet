...
class EditEmail extends StatefulWidget {
  final Usuario user;
  const EditEmail({required this.user, super.key});
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text("Editar e-mail", style: TextStyle(fontSize: 20, color: Color(0xff10172c)),),
                                ],
                              ),
                            ),
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text("Endereço de E-mail Antigo", style: TextStyle(color: Color(0xff979798), fontWeight: FontWeight.w700),),
                                  Container(
                                    decoration: BoxDecoration(
                                        color: Colors.white,
                                        border: Border.all(
                            ...
                            Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Novo Endereço de E-mail", style: TextStyle(color: Color(0xff979798), fontWeight: FontWeight.w700),),
                                  Container(
                                    decoration: BoxDecoration(
                                        color: Colors.white,
                                        border: Border.all(
                            ...
                            Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Senha", style: TextStyle(color: Color(0xff979798), fontWeight: FontWeight.w700),),
                                  Container(
                                    decoration: BoxDecoration(
                                        color: Colors.white,
                                        border: Border.all(
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if(controller.text.isEmpty || !emailRegex.hasMatch(controller.text)){
                            ...
                            await UsuarioService().changeEmail(controller.text, controllerSenha.text, widget.user);
                            Navigator.pop(context);
                          },
                          child: const Text(
                            'Salvar',
